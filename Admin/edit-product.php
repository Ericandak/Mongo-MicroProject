...
$collection = $mongoClient->Micro;
$product = $collection->Product_tbl->findOne(['_id' => new MongoDB\BSON\ObjectId($proId)]);
?>
<!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="editpro.php?idd=<?=$proId?>" class="tm-edit-product-form" method="POST" enctype="multipart/form-data">
